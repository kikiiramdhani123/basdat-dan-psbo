...
function gen_menu() {
	...
	if ($sess_level == "guru") {
	  ...
	  $menu = array(
	            ...
	            array("icon"=>"list-alt", "url"=>"m_mapel", "text"=>"Data Modul"),
	            array("icon"=>"list-alt", "url"=>"m_soal", "text"=>"Soal"),
	            array("icon"=>"file", "url"=>"h_ujian", "text"=>"Hasil Ujian"),
	          );
	} else {
	...
	if ($menu != null) {
		...
		<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">'; 
		    foreach ($menu as $m) {
		        if ($url == $m['url']) {
		          echo '<li class="active"><a href="'.base_url().'adm/'.$m['url'].'"><i class="fa fa-'.$m['icon'].'"></i> '.$m['text'].' </a></li>';
		        } else {
		          echo '<li><a href="'.base_url().'adm/'.$m['url'].'"><i class="fa fa-'.$m['icon'].'"></i> '.$m['text'].' </a></li>';
		        }
		    }
